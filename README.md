...
- An **Azure API Management** instance (any tier: Developer, Basic, Standard, Premium, v2).
...
| `rdwr-api-key`    | `your-api-key`                       | API key from the Radware Cloud portal — store as **secret** |
